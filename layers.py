...
from keras import backend as K
from keras.layers import Layer, InputLayer, InputSpec
...
class VariationalDropout(Layer):
    ...
    def call(self, inputs, training=None):
        if 0. < self.rate < 1.:
            ...
            noise_shape = [shape if (type(shape) is int and shape > 0) else symbolic_shape[axis] for axis, shape in enumerate(self.noise_shape)]
